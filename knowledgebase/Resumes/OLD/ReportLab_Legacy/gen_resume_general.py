...
def build_resume(output_path, monogram_path):
    ...
    skills = [
        ...
        ("Video Editing:", "Video Editing Software, Motion Graphics, Social Media Understanding, QC"),
        ...
        ("AI:", "Veo, Sora, Kling, Flux, Hailuo, AI Foundation Models"),
    ]
    ...
    j1_bullets = [
        "Produce and direct video production campaigns: launch pieces, explainers, interviews, and large event packages",
        "Lead projects end-to-end with clear milestones, delivering high-end video editing and finishing for Fortune 500 brands",
        "Build internal workflow tools and API pipelines to automate video production processes and accelerate delivery times",
...
OUTPUT = '/Volumes/WORK 2TB/SAVE/AGENTMONEY/KNOWLEDGE_BASE/Resumes/Jeff_Kerr_Resume_General.pdf'
