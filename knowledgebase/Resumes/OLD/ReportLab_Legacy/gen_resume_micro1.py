"""
General Video + AI Resume (Targeted: Micro1.ai Lightworks Post-Production Specialist)
Tailored for: AI workflow evaluation, Lightworks/NLE mastery, node-based VFX, media management.
"""
...
def build_resume(output_path, monogram_path):
    ...
    c.drawString(136.9, ytop_to_baseline(59.6, 10), "Post-Production Specialist / Editor")
    ...
    summary = (
        "Post-Production Specialist combining deep hands-on mastery of complex NLEs (Lightworks, Premiere, Resolve) with the technical acumen to evaluate and refine AI-driven editing workflows. Expert in advanced trimming, multi-cam workflows, fixed vs flexible layouts, and node-based VFX compositing. Proven track record managing complex remote post-production environments, ensuring flawless media management, proxy workflows, metadata handling, and strict EDL/XML/AVID interchange compatibility."
    )
    ...
    skills = [
        ("Editorial / VFX:", "Advanced Trimming, Console-driven Editing, Multi-cam, Node-based VFX, LUT Color Grading"),
        ("Media Mgmt:", "Proxy Workflows, Shared Project Metadata, Link-based Media, Asset Organization"),
        ("AI Evaluation:", "Auditing AI NLE Instructions, Testing AI Assistance, Refining Cinematic Workflow Rules"),
        ("Workflows:", "Fixed vs Flexible Layouts, Broadcast Standards, EDL/XML/AAF formats, ProTools Interchange"),
        ("Tools:", "Lightworks, DaVinci Resolve, Fusion, Premiere Pro, After Effects, AVID, Cinema 4D"),
        ("Creative Dev:", "Python, Node/React, API Pipelines, Browser Automation, Video Pipeline Tooling"),
    ]
    ...
    j1_bullets = [
        "Deliver high-end post-production campaigns, leveraging professional mastery of NLEs for rapid, keyboard-driven editing logic and complex media administration",
        "Implement and execute advanced workflow operations including multi-cam synchronization, node-based visual effects, cinematic LUT grading, and metadata handling",
    ...
    j2_bullets = [
        ...
        "Tightened review cadence and refreshed creative standards, delivering precise, granular feedback loop improvements to creative and technical teams",
    ]
