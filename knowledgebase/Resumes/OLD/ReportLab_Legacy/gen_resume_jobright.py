"""
JobRight General Resume
Based on: gen_resume_general.py (proven layout system, no modifications to coordinates).
Content: Identical to master resume. Only output filename differs.
Rules: No em-dashes.
"""
...
OUTPUT = '/Volumes/WORK 2TB/SAVE/AGENTMONEY/KNOWLEDGE_BASE/Resumes/Jeff_Kerr_Resume_JobRight.pdf'
